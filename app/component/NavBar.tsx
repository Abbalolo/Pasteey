...
function NavBar() {
  ...
  return (
    <header className='px-5 lg:px-16  py-5 flex justify-between items-center'>
      ...
      <nav onClick={() => setIsOpen(true)} className={!isOpen ? "static bg-transparent p-0 border-non shadow-none hidden md:flex" : "z-50 absolute left-0 top-16 w-full h-[25%] bg-white p-5 border border-t-transparent border-r-transparent border-l-transparent shadow-sm flex transition-all duration-300 ease-in"}>
